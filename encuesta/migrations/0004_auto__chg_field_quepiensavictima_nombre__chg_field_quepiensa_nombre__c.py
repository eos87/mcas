...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuePiensaVictima.nombre'
        db.alter_column('encuesta_quepiensavictima', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'QuePiensa.nombre'
        db.alter_column('encuesta_quepiensa', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PorqueAbuso.nombre'
        db.alter_column('encuesta_porqueabuso', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'QuePiensaVictima.nombre'
        db.alter_column('encuesta_quepiensavictima', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'QuePiensa.nombre'
        db.alter_column('encuesta_quepiensa', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'PorqueAbuso.nombre'
        db.alter_column('encuesta_porqueabuso', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'encuesta.conocimiento': {
            ...
            'nombre_ley': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['encuesta.Ley']", 'null': 'True', 'blank': 'True'}),
