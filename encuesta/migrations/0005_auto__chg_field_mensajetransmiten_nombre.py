...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MensajeTransmiten.nombre'
        db.alter_column('encuesta_mensajetransmiten', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'MensajeTransmiten.nombre'
        db.alter_column('encuesta_mensajetransmiten', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=80))
