...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ley'
        db.create_table('encuesta_ley', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('encuesta', ['Ley'])

        # Adding M2M table for field nombre_ley on 'Conocimiento'
        db.create_table('encuesta_conocimiento_nombre_ley', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('conocimiento', models.ForeignKey(orm['encuesta.conocimiento'], null=False)),
            ('ley', models.ForeignKey(orm['encuesta.ley'], null=False))
        ))
        db.create_unique('encuesta_conocimiento_nombre_ley', ['conocimiento_id', 'ley_id'])


    def backwards(self, orm):
        
        # Deleting model 'Ley'
        db.delete_table('encuesta_ley')

        # Removing M2M table for field nombre_ley on 'Conocimiento'
        db.delete_table('encuesta_conocimiento_nombre_ley')
