...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.usuario'
        db.add_column('encuesta_organizacion', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Encuesta.user'
        db.add_column('encuesta_encuesta', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.usuario'
        db.delete_column('encuesta_organizacion', 'usuario_id')
